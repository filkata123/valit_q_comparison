...
# User parameters
# =========================
CSV_PATH = "stochastic_learning_rate_results_100_samples.csv"   # path to your CSV file
...
plot_3d(
    ...
    title="Avg Iterations vs Alpha and Probability of Successful Transition"
)
...
plot_3d(
    ...
    title="Avg Time vs Alpha and Probability of Successful Transition"
)
...
plot_3d(
    ...
    title="Avg Action Count vs Alpha and Probability of Successful Transition"
)

plot_3d(
    df,
    z_col="Avg convergence action",
    z_label="Average convergence action (70k = no conv)",
    title="Avg Convergence Action vs Alpha and Probability of Successful Transition"
)
